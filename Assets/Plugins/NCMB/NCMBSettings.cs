	...
	public class NCMBSettings : MonoBehaviour
	{
		...
		public virtual void Awake ()
		{
			if (!NCMBSettings._isInitialized) {
				...
				string applicationKey = Resources.Load<TextAsset>("ApplicationKey").ToString();
				string clientKey = Resources.Load<TextAsset>("ClientKey").ToString();
				Initialize(applicationKey, clientKey, this.domainURL, this.apiVersion);
